...
function shoppingTime(memberId, money) {
  ...
  if (purchMoney > sepatu) {
    listed.push("Sepatu brand Stacattu");
    purchMoney -= sepatu;
  }
  if (purchMoney > zoro) {
    listed.push("Baju brand Zoro");
    purchMoney -= zoro;
  }
  if (purchMoney > hn) {
    listed.push("Baju brand H&N");
    purchMoney -= hn;
  }
  if (purchMoney > uniklooh) {
    listed.push("Sweater brand Uniklooh");
    purchMoney -= uniklooh;
  }
  if (purchMoney > casing) {
    listed.push("Casing Handphone");
    purchMoney -= casing;
  }
